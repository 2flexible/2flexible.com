...
This method based on https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/font
...
This method based on https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/miterLimit

```javascript
block.miterLimit(option);
```
...
- **measureText** : TextMetrics | undefined
...
- **pointInStroke** : boolean | undefined
